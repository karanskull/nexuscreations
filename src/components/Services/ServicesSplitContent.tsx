    ...
    <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center mb-24">
      <div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          <button className="px-8 py-4 bg-black text-white rounded-xl hover:bg-gray-900 transition-all duration-200 flex items-center justify-center group">
            Get Free Quote
            <ArrowRight className="ml-2 h-5 w-5 transform group-hover:translate-x-1 transition-transform" />
          </button>
          <button className="px-8 py-4 border-2 border-black text-black rounded-xl hover:bg-gray-50 transition-all duration-200">
            View Portfolio
          </button>
        </div>
      </div>
